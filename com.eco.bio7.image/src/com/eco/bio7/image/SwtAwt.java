...
public class SwtAwt {
	...
	/**
	 * <p>
	 * Workaround for Eclipse bug 377104 where frame activation is not being
	 * properly propagated into SWT on Java 7.
	 * </p>
	...
	public static void setSwtAwtFocus(final Frame frame, final Composite embedded) {
		...
		frame.addWindowListener(new java.awt.event.WindowAdapter() {
			...
			public void windowActivated(java.awt.event.WindowEvent e) {
				System.out.println("activated frame");
					...
					public void run() {
						if (Display.getCurrent().getFocusControl() == embedded) {
							...
							try {
								...
								// LOG.severe("SEVERE: Embedded part was not able to set active control on
								// Shell. This will result in other workbench parts not getting activated.");
							} finally {
								if (m != null) {
