...
//n__ begin mouseMoved
	...
	/*
	 * public static void setLiveMode(Boolean set) { ImagePlus imp =
	 * WindowManager.getCurrentImage(); ImageWindow win =
	 * imp!=null?imp.getWindow():null; PlotWindow pw = win!=null && (win
	 * instanceof PlotWindow)?(PlotWindow)win:null; if (pw!=null &&
	 * pw.live.getForeground()!=Color.red) pw.enableLiveProfiling(); }
	 */
