...
public class Roi extends Object implements Cloneable, java.io.Serializable, Iterable<Point> {
	...
	public static final int RECTANGLE = 0, OVAL = 1, POLYGON = 2, FREEROI = 3, TRACED_ROI = 4, LINE = 5, POLYLINE = 6, FREELINE = 7, ANGLE = 8, COMPOSITE = 9, POINT = 10; // Types
	...
	public double[] getFeretValues() {
		...
		for (int i = 0; i < poly.npoints; i++) { // find caliper width for one side of calipers touching points i-1, i
			...
			xnorm *= normalizationFactor * pw; // normalized vector perpendicular to line between i-1, i; * scale factor for
								// product below
	...
	protected int screenX(int ox) {
		return ic != null ? ic.screenX(ox) : ox;
	}

	protected int screenY(int oy) {
		return ic != null ? ic.screenY(oy) : oy;
	}
