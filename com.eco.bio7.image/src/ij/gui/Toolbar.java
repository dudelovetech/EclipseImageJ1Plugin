...
public class Toolbar extends JPanel implements MouseListener, MouseMotionListener, ItemListener, ActionListener {
	...
	public static final String[] builtInTools = {"Arrow","Brush","Command Finder", "Developer Menu","Flood Filler", "LUT Menu","Overlay Brush","Pencil","Pixel Inspector","Selection Rotator", "Spray Can", "Stacks Menu" };
