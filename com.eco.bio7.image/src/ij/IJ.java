...
public class IJ {
	 ...
	 * executing. To generate run() calls, start the recorder
	 * (Plugins/Macro/Record) and run commands from the ImageJ menu bar.
	 */
	 ...
	 * run() calls, start the recorder (Plugins/Macro/Record) and run commands
	 ...
	 * "Black & White", "Over/Under" or "No Update"). With calibrated images,
	 * 'lowerThreshold' and 'upperThreshold' must be density calibrated values.
	 * Use setRawThreshold() to set the threshold using raw (uncalibrated)
	 * values.
	 */
	 ...
	 * display the image and return null. Use IJ.open() to display a file open
	 * dialog box.
	 */
	...
	/**
	 * Returns the object in IJ.properties associated with 'key', or null if
	 * 'key' is not found.
	 */
