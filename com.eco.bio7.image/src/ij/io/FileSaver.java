...
public class FileSaver {
	...
	/**
	 * Resaves the image. Calls saveAsTiff() if this is a new image, not a TIFF, or
	 * if the image was loaded using a URL. Returns false if saveAsTiff() is called
	 * and the user selects cancel in the file save dialog box.
	 */
	public boolean save() {
		FileInfo ofi = null;
		if (imp != null)
	...
	/**
	 * Saves the image or stack in TIFF format using a save file dialog. Returns
	 * false if the user selects cancel. Equivalent to IJ.saveAsTiff(imp,""), which
	 * is more convenient.
	 */
	...
	/**
	 * Saves the stack as a multi-image TIFF using the specified path. Equivalent to
	 * IJ.saveAsTiff(imp,path), which is more convenient.
	 */
	...
	/**
	 * Converts this image to a TIFF encoded array of bytes, which can be decoded
	 * using Opener.deserialize().
	 */
	...
	/**
	 * Save the image in GIF format using a save file dialog. Returns false if the
	 * user selects cancel or the image is not 8-bits.
	 */
	...
	/**
	 * Save the image in Gif format using the specified path. Returns false if the
	 * image is not 8-bits or there is an I/O error.
	 */
	...
	/**
	 * Save the image in JPEG format using a save file dialog. Returns false if the
	 * user selects cancel.
	 * 
	 * @see #setJpegQuality
	 * @see #getJpegQuality
	...
	/**
	 * Save the image in BMP format using a save file dialog. Returns false if the
	 * user selects cancel.
	 */
	...
	/**
	 * Saves grayscale images in PGM (portable graymap) format and RGB images in PPM
	 * (portable pixmap) format, using a save file dialog. Returns false if the user
	 * selects cancel.
	 */
	...
	/**
	 * Saves grayscale images in PGM (portable graymap) format and RGB images in PPM
	 * (portable pixmap) format, using the specified path.
	 */
	...
	/**
	 * Save the image in PNG format using a save file dialog. Returns false if the
	 * user selects cancel.
	 */
	...
	/**
	 * Save the image in FITS format using a save file dialog. Returns false if the
	 * user selects cancel.
	 */
	...
	/**
	 * Save the image or stack as raw data using a save file dialog. Returns false
	...
	/**
	 * Save the image as tab-delimited text using a save file dialog. Returns false
	 * if the user selects cancel.
	 */
