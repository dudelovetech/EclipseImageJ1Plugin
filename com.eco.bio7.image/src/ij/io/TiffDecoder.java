...
/**
 * Decodes single and multi-image TIFF files. The LZW decompression code was
 * contributed by Curtis Rueden.
 */
public class TiffDecoder {
	...
	/**
	 * Save the image description in the specified FileInfo. ImageJ saves spatial
	 * and density calibration data in this string. For stacks, it also saves the
	 * number of images to avoid having to decode an IFD for each image.
	 */
