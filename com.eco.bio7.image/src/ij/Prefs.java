...
public class Prefs {
	...
	/**
	 * Saves <code>value</code> in the preferences file using the keyword
	 * <code>key</code>. This value can be retrieved using the appropriate
	 * <code>getPref()</code> method.
	 */
