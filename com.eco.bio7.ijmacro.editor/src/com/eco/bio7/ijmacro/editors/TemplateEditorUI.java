...
public class TemplateEditorUI  {
	...
	public TemplateStore getTemplateStore() {
		if (fStore == null) {
			fStore= new ContributionTemplateStore(getContextTypeRegistry(), IJMacroEditorPlugin.getDefault().getPreferenceStore(), CUSTOM_TEMPLATES_KEY);
			try {
				fStore.load();
			} catch (IOException e) {
	...
	public ImageRegistry getImageRegistry() {
		return IJMacroEditorPlugin.getDefault().getImageRegistry();
	}
	...
	public IPreferenceStore getPreferenceStore() {
		return IJMacroEditorPlugin.getDefault().getPreferenceStore();
	}

	public void savePluginPreferences() {
		IJMacroEditorPlugin.getDefault().savePluginPreferences();
	}
